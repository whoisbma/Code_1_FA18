...
// visualizing key presses 1

// this code is from the Keyboard Functions example in the Processing
// example sketches.
...
// take this code as inspiration for writing a new sketch that visualizes 
// key and mouse input as visuals on the screen. see the next sketch, 
// w11_05_visualizingInput2, for a starting point to build on that uses 
// the basics of this approach. 

// (optional: for a more flexible approach, use objects to represent your visualized
// elements instead of just drawing a shape to the screen that isn't updating
// its background.)
